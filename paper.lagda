...
%TODO mandatory: add short abstract of the document \begin{abstract}
...
\section{Single substitution syntax is isomorphic to parallel substitution syntax}

This is like SK is isomorphic to lambda calculus. Parallel models are SSC models, but not the other way (do we have a counterexample?).
