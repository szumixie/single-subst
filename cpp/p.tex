...
\begin{definition}[Single substitution calculus with $\Pi$, $\U$, $\Lift$, $\top$, and $\Sigma$ types]\label{def:sigma}
  ...
  \begin{alignat*}{10}
    & \top && : \Ty\,\Gamma\,0 && \top[] && : \top[\gamma] = \top\hspace{6em} && \top\eta && : t = \tt \\
    & \tt && : \Tm\,\Gamma\,\top \hspace{6em} && \tt[] && : \tt[\gamma] = \tt \\
    & \Sigma && : \rlap{$(A:\Ty\,\Gamma\,i)\ra\Ty\,(\Gamma\ext A)\,i\ra\Ty\,\Gamma\,i \hspace{4.4em} \Sigma[] : (\Sigma\,A\,B)[\gamma] = \Sigma\,(A[\gamma])\,(B[\gamma^+])$} \\
    & \fst,\snd && : \rlap{$\Tm\,\Gamma\,(\Sigma\,A\,B)\cong(a:\Tm\,\Gamma\,A)\times\Tm\,\Gamma\,(B[\langle a\rangle]) : \blank{,}\blank \hspace{1.6em} {,}[] : (a,b)[\gamma] = (a[\gamma],b[\gamma])$}
  \end{alignat*}
