...
\newcommand{\Agda}{%
  \raisebox{-.15em}{\includegraphics[height=.9em]{agda-logo.pdf}}%
}
...
assistant Agda. The formalisation is availble at TODO \href{https://szumixie.github.io/single-subst/TT.index.html}{\Agda}. We use a strict
...
names to the roundtrips equations according to our convention introduced in
...
The other roundtrip is exactly $\Pi\eta : \lam\,(t[\p]\cdot\q) = t$.
...
\end{equation}
To derive the roundtrips, we again need admissible equations. We prove
the first roundtrip equality in Appendix \ref{app:liftvar}, the other
is analogous.
...
be minimised even more, e.g.\ to the degree that there is only one
equation between any two terms. This would be interesting for a
possible coherent syntax of type theory avoiding the need for
truncation in the setting of homotopy type theory.
...
Here we prove one of the roundtrips in the isomorphism
